#pragma checksum "C:\Users\mitch\source\repos\Brians Website\Brians Website\Views\Contact\Contact.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8d6f3de89f1b3a9e2253021cccdd49ba73a88145"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8d6f3de89f1b3a9e2253021cccdd49ba73a88145", @"/Views/Contact/Contact.cshtml")]
...
<div id=""homemenucircle"">
    <nav class='menu'>
        ...
        <ul>
            <li class='menu-item'>
                <a class='fa fa-facebook' href='https://www.facebook.com/' target='_blank'><i class=""fa fa-cog""></i></a>
            </li>
            <li class='menu-item'>
                <a class='fa fa-google' href='https://www.google.com/' target='_blank'><i class=""fa fa-cog""></i></a>
            </li>
            <li class='menu-item'>
                <a class='fa fa-dribbble' href='https://dribbble.com/' target='_blank'><i class=""fa fa-cog""></i></a>
            </li>
            <li class='menu-item'>
...
<style>
    .menu-toggler {
        ...
        .menu-toggler:checked + label {
            ...
            .menu-toggler:c");
            WriteLiteral(@"hecked + label:before {
        ...
        .menu-toggler + label {
            ...
            .menu-toggler + label:before, .menu-toggler + label:after {
                ...
                transition: transform 0.5s, top 0.5s;
                transition: transform 0.5s, top 0.5s, -");
            WriteLiteral(@"webkit-transform 0.5s;
                content: """";
                position: absolute;
                left: 0;
            }
